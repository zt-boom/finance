...
totalZfbProfitElement.textContent = formatCurrency(totalZfbAmount * (totalHoldingAmount > 0 ? totalProfit / totalHoldingAmount : 0));
}
const totalStockProfitElement = document.getElementById("total-stock-profit");
if (totalStockProfitElement) {
totalStockProfitElement.textContent = formatCurrency(totalStockAmount * (totalHoldingAmount > 0 ? totalProfit / totalHoldingAmount : 0));
}
